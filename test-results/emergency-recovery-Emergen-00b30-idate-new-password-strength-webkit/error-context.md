...
- Name: emergency-recovery.spec.ts >> Emergency Recovery for Super-Admins >> should validate new password strength
- Location: e2e\emergency-recovery.spec.ts:31:7
...
Call log:
  - waiting for locator('input[name="token"]')
...
- main [ref=e2]:
  - generic [ref=e3]:
    - generic [ref=e4]: 🕌
    - heading "Page introuvable" [level=1] [ref=e5]
    - paragraph [ref=e6]: Cette page n'existe pas.
