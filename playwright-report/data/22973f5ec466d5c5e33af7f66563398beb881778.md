...
- Name: mfa.spec.ts >> MFA (Multi-Factor Authentication) for Super-Admins >> should require TOTP code to confirm MFA setup
- Location: e2e\mfa.spec.ts:26:7
    ...
    - generic [ref=e8]:
      - generic [ref=e9]:
        ...
        - generic [ref=e13]:
          ...
          - textbox "••••••••" [ref=e15]
        - link "Mot de passe oublié ?" [ref=e17]:
          - /url: /forgot-password
        - button "Se connecter" [ref=e18]
      - paragraph [ref=e20]:
        - text: Pas encore de compte ?
        - link "S'inscrire" [ref=e21]:
          - /url: /register
    - link "← Retour à l'accueil" [ref=e23]:
      - /url: /
```
