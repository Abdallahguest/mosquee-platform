...
// Page de repli hors-ligne AUTONOME.
// Elle rend sa propre structure HTML (html/body) car le layout racine du projet
// ne fournit pas ces balises (elles sont dans [locale]/layout). Tous les styles
// sont en ligne (inline) pour ne dépendre d'AUCUN fichier externe : garantie
// d'affichage même sans réseau.
//
// Anti-gharar : la date d'enregistrement est affichée clairement.
...
const S = {
  ...
  wrap: { maxWidth: 520, margin: "0 auto", padding: "32px 24px" } as React.CSSProperties,
  center: { textAlign: "center" as const, marginBottom: 24 },
    ...
    return (
      <div style={{ ...S.wrap, textAlign: "center", paddingTop: 80 }}>
        ...
        <p style={{ ...S.sub, maxWidth: 360, margin: "0 auto" }}>
          ...
          pour accéder aux horaires hors connexion par la suite.
        </p>
      </div>
    )
  }
...
// La page rend sa PROPRE structure HTML (le layout racine ne le fait pas).
