...
- Name: self-service-registration.spec.ts >> Self-Service Registration Flow >> should validate required fields
- Location: e2e\self-service-registration.spec.ts:27:7
...
Locator: locator('text=Nom requis')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=Nom requis')
